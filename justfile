...
# Runs the local Synapse startup-timing regression suite
test-synapse-startup-timing:
    @"{{ justfile_directory() }}/roles/custom/matrix-synapse/tests/run-startup-timing-suite.sh"
