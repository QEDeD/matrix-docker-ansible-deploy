...
PLAYBOOK="${REPO_ROOT}/roles/docker_ansible_summary/tests/local_suite.yml"
...
OUTPUT_PLAYBOOK="${REPO_ROOT}/roles/docker_ansible_summary/tests/output_snapshot.yml"
...
if ! python3 "${REPO_ROOT}/roles/docker_ansible_summary/tests/check_table_alignment.py" "${OUTPUT_LOG}"; then
