...
MUST NOT edit directly in normal operator workflows:
- `roles/galaxy/**` (vendor/fetched roles)

Contributor mode may edit upstream-tracked playbook/docs/code files, but still follow branch and safety policy.
