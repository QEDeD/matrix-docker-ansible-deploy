...
# AGENTS.md - matrix-docker-ansible-deploy
...
- `group_vars/matrix_servers` (template-derived)
...
- Put transient artifacts under `/tmp/matrix-docker-ansible-deploy-agent-*`.
...
- Treat disable/uninstall toggles, identifier/path changes, and cleanup/prune actions as retention-risky; consult `docs/uninstalling.md` and `docs/playbook-tags.md`.
...
- Command catalogs and examples: `docs/ai/agent_workflows.md`, `docs/just.md`, and `docs/playbook-tags.md`.
